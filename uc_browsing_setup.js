...
c_DEFAULT_UC_BROWSING_SETUP.tree_data_src_type = c_DATA_SOURCE_TYPE_ID_XML;  //  // c_DATA_SOURCE_TYPE_ID_DISCO; // 
c_DEFAULT_UC_BROWSING_SETUP.tree_data_src_path = //"disconet.lynx.uberspace.de/node/api/odata";  // "test.disco-network.org/api/odata"; 
...
c_DEFAULT_UC_BROWSING_SETUP.tree_data_src_params.root_item = "root"; //"1"; //"575" // 
